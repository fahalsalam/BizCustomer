...
VenorModel venorModelFromJson(String str) =>
    VenorModel.fromJson(json.decode(str));

String venorModelToJson(VenorModel data) => json.encode(data.toJson());
...
class VenorModel {
  ...
  factory VenorModel.fromJson(Map<String, dynamic> json) => VenorModel(
...
class Vendor {
  ...
  dynamic idProofPicUrl2;
  dynamic idProofPicUrl3;
