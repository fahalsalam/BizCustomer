...
//
//     final walletStoreModel = walletStoreModelFromJson(jsonString);

import 'dart:convert';

WalletStoreModel walletStoreModelFromJson(String str) =>
    WalletStoreModel.fromJson(json.decode(str));

String walletStoreModelToJson(WalletStoreModel data) =>
...
class WalletStoreModel {
  ...
  factory WalletStoreModel.fromJson(Map<String, dynamic> json) =>
      WalletStoreModel(
